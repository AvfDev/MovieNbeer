...
import com.avfsoftware.pelinabeer.Adapters.PagerTabAdapter;
...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            final PagerTabAdapter adapter = new PagerTabAdapter(getSupportFragmentManager());
